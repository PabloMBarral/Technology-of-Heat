...
caudal_vapor_sobrecalentado = 180 # t/h
...
caudal_extraccion_turbina = 130 # t/h
...
c[47] = Connection(HPEC2, 'out1', LPEV1_gases , 'in1', label='48')
...
c[48] = Connection(LPEV1_gases, 'out1', HPEC1 , 'in1', label='49')
